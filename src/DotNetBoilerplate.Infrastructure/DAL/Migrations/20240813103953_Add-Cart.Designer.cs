...
namespace DotNetBoilerplate.Infrastructure.DAL.Migrations
{
    ...
    [Migration("20240813103953_Add-Cart")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DotNetBoilerplate.Core.Carts.Cart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("Carts", "dotNetBoilerplate");
                });

            modelBuilder.Entity("DotNetBoilerplate.Core.Carts.CartItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CartItems", "dotNetBoilerplate");
                });
            ...
            modelBuilder.Entity("DotNetBoilerplate.Core.Carts.CartItem", b =>
                {
                    b.HasOne("DotNetBoilerplate.Core.Carts.Cart", null)
                        .WithMany("Items")
